            ...
            <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 w-full">
                <div className="w-full lg:w-3/5 text-center lg:text-left pt-12 lg:pt-0">
                    ...
                    <p className="mb-12 max-w-xl text-base text-text-secondary md:text-lg mx-auto lg:mx-0">
                        Java &amp; Python backend developer with 3.5+ years building ERP and e-commerce platforms. Currently pursuing M.Sc. Digital Engineering at Otto-von-Guericke-Universität Magdeburg &mdash; focused on integrating intelligent features into real business applications.
                    </p>
